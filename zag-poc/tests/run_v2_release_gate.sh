...
unsupported "atomics and concurrency" "fixed unsafe x86-64 i64 operations, raw Linux i32 futex wait/wake, and literal-validated load/store/RMW/CAS/fence orders exist, but atomic storage, language-wide fence semantics, threads, litmus evidence, and a v2 concurrency model remain incomplete"
