...
| 7. CPU control | unsafe/target model | asm operand/clobber validation and machine-code tests | PARTIAL: validated x86 POPCNT, BMI1 ANDN, trailing-zero, byte-swap, leading-zero, and baseline prefetch paths have machine-code/runtime evidence; packed SIMD, inline asm constraints, and full target-feature/effect contracts remain |
